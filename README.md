...
# 📖 my_enumerable <a name="about-project"></a>
 ...
 This app is a pair programming app  to an enumerable class with instances using Ruby as the programming language.
...
```
git clone https://github.com/Armynerh/my_enumerable.git
...
Feel free to check the [issues page](https://github.com/Armynerh/my_enumerable/issues).
